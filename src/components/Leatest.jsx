...
const Leatest = () => {
  ...
  let NewArrival = data.filter(
    (product) => product.id >= 115 && product.id <= 120
  );
  let BestSeller = data.filter(
    (product) => product.id >= 110 && product.id <= 115
  );
  let Featured = data.filter(
    (product) => product.id >= 135 && product.id <= 140
  );
  let SpecialOffer = data.filter(
    (product) => product.id >= 160 && product.id <= 165
  );
  ...
  return (
    <div className="py-[50px] lg:px-0 px-3">
      <Container>
        <h2 className="lg:text-[42px] text-[20px] font-joss font-bold pb-[48px] text-center">
          Leatest Products
        </h2>
        <Tabs.Root defaultValue="react">
          <Tabs.List className="flex lg:gap-x-16 gap-x-5 justify-center pb-10">
            <Tabs.Trigger
              className="font-joss lg:text-[20px] text-[12px] font-normal underline"
              value="react"
            >
              New Arrival
            </Tabs.Trigger>
                  ...
                  <div className="lg:w-[32%] w-full group lg:mb-[100px] mb-5">
                    <div className="w-full bg-[#F6F7FB] h-[270px] py-3 flex justify-center relative overflow-hidden group-hover:overflow-visible group-hover:bg-white duration-700 ease-in-out lg:hover:scale-110">
                      ...
                      <div className="absolute top-7 left-2 -rotate-[25deg] opacity-0 group-hover:opacity-100 duration-700 ease-in-out">
                        <h5 className="text-[16px] text-[#FFF] px-[50px] py-2 bg-[#3F509E] duration-300 ease-in-out">
                          Sale
                        </h5>
                      </div>
                    </div>
                    <div className="flex justify-between pt-3 bg-white">
                      <div className="">
                        <h4 className="lg:text-[16px] text-[14px] font-normal text-[#151875]">
                          {item.title}
                        </h4>
                      </div>
                      <div className="flex">
              ...
              <div className="=lg:flex justify-between flex-wrap">
                {BestSeller.map((item) => (
                  <div className="lg:w-[32%] w-full group lg:mb-[100px] mb-5">
                    ...
                    <div className="flex justify-between pt-3 bg-white">
                      <div className="">
                        <h4 className="text-[16px] font-normal text-[#151875]">
                          {item.title}
                        </h4>
                      </div>
                      <div className="flex">
