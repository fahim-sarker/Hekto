            ...
            <section className='py-[70px]'>
                <Container>
                    <div className="flex justify-center">
                        <h2 className='text-[42px] font-joss font-bold pb-[48px]'>Featured Products</h2>
                    </div>
                    <Link to="/shop">
                        <div className="">
                            <Slider {...settings}>
                            {data.map((item)=>(
                                    <div className="relative !w-[93%] group h-[500px]">
                                        ...
                                        <div className="flex justify-center shadow-xl py-5 group-hover:bg-[#2F1AC4] duration-700 ease-in-out group-hover:text-white">
                                            <div className="">
                                                <h2 className='text-[18px] font-joss font-bold py-[10px] text-pink-600 group-hover:text-white duration-700 ease-in-out'>{item.title}</h2>
                                                ...
                                                <h3 className='text-[18px] font-joss font-bold text-center'>Code - Y523201</h3>
                                            ...
                                            <button className='text-[18px] font-joss font-medium py-3 px-4 bg-[#08D15F] text-white absolute bottom-[35%] left-[30%] opacity-0 group-hover:opacity-100 duration-700 ease-in-out'>View Details</button>
                                        </div>
                                    </div>                 
                            ))}
                            </Slider>
